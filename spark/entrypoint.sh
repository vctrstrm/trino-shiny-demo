...
spark.sql.catalog.vastberg=org.apache.iceberg.spark.SparkCatalog
spark.sql.catalog.vastberg.catalog-impl=org.apache.iceberg.nessie.NessieCatalog
spark.sql.catalog.vastberg.uri=$NESSIE_DOCKER_INTERNAL_API_URI
spark.sql.catalog.vastberg.ref=main
spark.sql.catalog.vastberg.authentication.type=NONE
spark.sql.catalog.vastberg.warehouse=s3://${VAST_ICEBERG_S3_BUCKET_NAME}/${VAST_ICEBERG_NESSIE_DEFAULT_WAREHOUSE_DIR}
spark.sql.catalog.vastberg.io-impl=org.apache.iceberg.aws.s3.S3FileIO
spark.sql.catalog.vastberg.s3.endpoint=$VAST_ENDPOINT
spark.sql.catalog.vastberg.client.region=us-east-1
spark.sql.catalog.vastberg.s3.path-style-access=true

spark.sql.catalog.iceberg=org.apache.iceberg.spark.SparkCatalog
spark.sql.catalog.iceberg.catalog-impl=org.apache.iceberg.nessie.NessieCatalog
spark.sql.catalog.iceberg.uri=$NESSIE_DOCKER_INTERNAL_API_URI
spark.sql.catalog.iceberg.ref=main
spark.sql.catalog.iceberg.authentication.type=NONE
spark.sql.catalog.iceberg.warehouse=s3://${LOCAL_ICEBERG_S3_BUCKET_NAME}/${LOCAL_ICEBERG_NESSIE_DEFAULT_WAREHOUSE_DIR}
spark.sql.catalog.iceberg.io-impl=org.apache.iceberg.aws.s3.S3FileIO
spark.sql.catalog.iceberg.s3.endpoint=$LOCAL_S3_DOCKER_INTERNAL_ENDPOINT
